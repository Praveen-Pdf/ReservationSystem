...
class TimeslotsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create timeslot" do
    assert_difference('Timeslot.count') do
      post timeslots_url, params: { timeslot: { date: @timeslot.date, end: @timeslot.end, name: @timeslot.name, start: @timeslot.start, status: @timeslot.status, table_id: @timeslot.table_id } }
    end
  ...
  test "should update timeslot" do
    patch timeslot_url(@timeslot), params: { timeslot: { date: @timeslot.date, end: @timeslot.end, name: @timeslot.name, start: @timeslot.start, status: @timeslot.status, table_id: @timeslot.table_id } }
