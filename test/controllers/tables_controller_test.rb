...
class TablesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create table" do
    assert_difference('Table.count') do
      post tables_url, params: { table: { capacity: @table.capacity, restaurant_id: @table.restaurant_id, table_name: @table.table_name } }
    end
  ...
  test "should update table" do
    patch table_url(@table), params: { table: { capacity: @table.capacity, restaurant_id: @table.restaurant_id, table_name: @table.table_name } }
